...
## **Bug_1:** 
### Название БР: 
В поле поиска не прогрузилась иконка "крестика" в кнопке сброса
### Приоритет: 
...
### Ожидаемый результат:
- В выдаче есть вакансии с табом команды
...
## **Bug_8:** 
### Название БР: 
При включенном чекбоксе "Руководящая роль" в выдаче присутствуют другие роли
### Приоритет: 
**high** (нарушает логику выдачи по запросу)
### Предусловие: 
1. Открыть страницу https://career.avito.com/vacancies/
...
*Возможно это не считается багом и просто в названии вакансии не передали смысл вакансии.*
***
